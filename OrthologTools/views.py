...
def shows():
	...
	#pathName = 'static/' + str(randomFileName) + '/'
	pathName = app.config['RESULTS_DIR'] + str(randomFileName) + "/"

	os.mkdir( pathName, 0755 );
	#fileName = 'static/' + str(randomFileName) + '/' + 'result.csv'
	fileName = pathName + 'result.csv'
    
	result.to_csv(fileName)
	
	#range_fileName = 'static/' + str(randomFileName) + '/range_' + 'query' + '.txt'
	range_fileName = pathName + 'range_query.txt'
	...
	#summary_fileName = 'static/' + str(randomFileName) + '/summary' + '.txt'
	summary_fileName = pathName + 'summary.txt'
	...
	if random_analysis_check == 'y':
		...
		#meta_file_name = 'static/' + str(randomFileName) + '/random_' + 'meta' + '.csv'
		meta_file_name = pathName + 'random_meta.csv'
		...
		while i <= n:
			...
			print "Search"
  			print result.apply(pandas.Series.nunique)
			print str(i) + "\n"
			#range_fileName = 'static/' + str(randomFileName) + '/range_' + str(i) + '.txt'
			range_fileName = pathName + 'range_' + str(i) + '.txt'
			...
			#fileName = 'static/' + str(randomFileName) + '/random_' + str(i) + '.csv'
			fileName = pathName + 'random_' + str(i) + '.csv'
